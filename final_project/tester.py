...
import pickle
import sys
#from sklearn.cross_validation import StratifiedShuffleSplit ''' old Version Py 2
...
def test_classifier(clf, dataset, feature_list, folds = 1000):
    ...
    try:
        ...
        print("Prfecision or recall may be undefined due to a lack of true positive predicitons.")
