### Function from my miscFunction.py
### Because there were problems with my miscFunction.py file, the import function failed.
### Traceback (most recent call last):
###   File "poi_id.py", line 4, in <module>
###     from final_project import tester
### ImportError: No module named final_project
import sys
...
### adapted Function From tester.py for without Print but return values
...
### This function compares a number bitwise with 
### a list, where each entry in the list corresponds 
### to one bit.
...
### This function can perform 3 algorithms by 
### trying with a given set of featuers.
def getBestFeaturesResult(algoNames, features_list_all, my_dataset, score = 'F1'):
    ...
    for each in resultList:
        print('|',resultList[each]['Algo'], '|', resultList[each]['recall'], '|', resultList[each]['precision'], '|', resultList[each]['accuracy'], '|', resultList[each]['F1'], '|', resultList[each]['featureList'], '|', resultList[each]['runtime'], '|')

### This function can set 6 parameters for the 
### decision tree by trying with a given set 
### of parameters.
...
### This function can set 4 parameters for 
### the KNeighbors by trying with a given 
### set of parameters.
...
from tester import main  as testerMain# old Version Py 2
